...
function filterValidating(keys) {
...
export function SWRDevtools({ debug = false, cache, position = "right", mutate, CustomOpenComponent, openBtnPosition = "left", defaultOpen = false, }) {
    ...
    const [cacheKeys, setCacheKeys] = useState(filterValidating(filterErrors(cache.keys())));
